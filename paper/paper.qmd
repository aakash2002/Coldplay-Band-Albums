...
# Introduction[intro]
This paper presents an analysis of Coldplay's albums from 2000 to 2024, using data collected from the Spotify API. The dataset was processed and cleaned in R to explore trends in the band's music, focusing on key attributes including key notes, energy of the songs, and tempo. 
